...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  // Short horizontal shake played on validation / login failure.
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      setState(() => _errorText = "Couldn't log in. Check your details and try again.");
      _playShake();
    } finally {
                  ...
                  child: ConstrainedBox(
                    ...
                    child: AnimatedBuilder(
                      ...
                      child: Container(
                        ...
                        // Wrapped in Center so the fixed 64x64 size survives the
                        // Column's stretch alignment instead of ballooning to
                        // full width (the bug that made it a wide pill on mobile).
                        _staggered(
                          start: 0.0,
                          end: 0.5,
                          child: Center(
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              ...
                              return Container(
                                ...
                                child: Text(
                                  'Your plants have been talking. Log in to hear from them.',
                                ...
                                child: Container(
                                  ...
                                  child: OutlinedButton(
                                    ...
                                    style: OutlinedButton.styleFrom(
                                      ...
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(isMobile ? 16 : 18)),
                                    ),
                                    child: Text(
                                      'Create account',
                                      style: TextStyle(
